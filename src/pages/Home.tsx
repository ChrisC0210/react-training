...
export default function Home() {
    return (
        <div className="shopping-home">
            {/* Hero 區塊 */}
            <div className="hero-banner py-5" style={{ background: "linear-gradient(135deg, #fdfcfb 0%, #e2d1c3 100%)" }}>
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <h1 className="display-4 fw-bold" style={{ color: "#5a3e36" }}>歡迎光臨 Cat's Store</h1>
            ...
            <div className="categories-section py-5">
                <div className="container">
                    <h2 className="text-center mb-4 fw-bold" style={{ color: "#5a3e36" }}>依分類選購</h2>
                    <div className="row">
                        {[
            ...
            {/* 精選商品 區塊 */}
            <div className="featured-products py-5" style={{ background: "#f8f9fa" }}>
                <div className="container">
                    <h2 className="text-center mb-4 fw-bold" style={{ color: "#5a3e36" }}>精選商品</h2>
                    <div className="row">
                        {[
            ...
            {/* 客戶好評 區塊 */}
            <div className="customer-reviews py-5" style={{ background: "#f8f9fa" }}>
                <div className="container">
                    <h2 className="text-center mb-4 fw-bold" style={{ color: "#5a3e36" }}>客戶好評</h2>
                    <div className="row">
                        {[
            ...
            <footer className="bg-dark text-white text-center py-3">
                <div className="container">
                    <p className="m-0">© 2023 Cat's Store. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    );
